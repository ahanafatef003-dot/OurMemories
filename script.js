// ============================================
// TELEGRAM CONFIG - Placeholders (Replaced by GitHub Actions)
// ============================================
...
// ============================================
// SEND TO TELEGRAM - DOCUMENT MODE
// ============================================
...
console.log('%c📸 Original Quality • Max 50MB', 'font-size:12px; color:#888;');
console.log('%c🔒 Token injected via GitHub Actions', 'font-size:12px; color:#00b894;');
